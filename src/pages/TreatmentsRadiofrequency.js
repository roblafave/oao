						...
						<div className='treatment-container'>
							<div className='row'>
								...
								<div className='col-sm-6'>
									<div className='treatment-title hidden-xs' style={{ marginTop: '150px' }}><h3><b>Radio Frequency</b></h3></div>
									<div className='treatment-title visible-xs' style={{ marginTop: '0px' }}><h3><b>Radio Frequency</b></h3></div>
