					...
					<div className='container'>
						<div className='row mb-100'>
							<div className='col-sm-12'>
								<h3>Over 18</h3>
								<p className='mt-30'>
									We’re so thrilled you want to build the next wave of tech leaders with us; the Wave program is currently only open to girls ages 15-18. Are you a professional? Shoot us a quick <a href="mailto:info@on-and-on.co?Subject=Request%20To%20Be%20An%20Advisor" target="_blank">email</a> to let us know that you'd like to be an Advisor. Otherwise, keep an eye out for our newsletter to stay in the loop on all of our programs.
								</p>
							</div>
						</div>
					</div>
